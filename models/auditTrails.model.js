...
const auditTrailsSchema = new mongoose.Schema({
    ...
    actionType:{
        type: String,
        required: true,
        enum: ["UPDATE_PROFILE", "CHANGE_PASSWORD", "DELETE_ACCOUNT", "DATA_EXPORT", "DATA_IMPORT", "SETTINGS_CHANGE", "SCHEME_COMPARISON", "ADD_TO_FAVORITES", "REMOVE_FROM_FAVORITES", "LOGIN", "LOGOUT"],
    },
    entity:{
        type: String,
        required: true,
    ...
    userAgent:{ //mobile/ windows/linux/mac/chrome/firefox
        type: String,
    }
},
{
